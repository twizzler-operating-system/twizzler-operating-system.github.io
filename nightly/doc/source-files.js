...
sourcesIndex["twizzler"] = {"name":"","dirs":[{"name":"object","files":["mod.rs"]}],"files":["lib.rs"]};
sourcesIndex["twizzler_abi"] = {"name":"","dirs":[{"name":"arch","dirs":[{"name":"x86_64","files":["mod.rs","syscall.rs"]}],"files":["mod.rs"]},{"name":"device","dirs":[{"name":"bus","files":["mod.rs","pcie.rs"]}],"files":["mod.rs"]},{"name":"llalloc","files":["hole.rs","mod.rs"]}],"files":["alloc.rs","aux.rs","exec.rs","kso.rs","lib.rs","load_elf.rs","object.rs","rt1.rs","simple_idcounter.rs","simple_mutex.rs","slot.rs","syscall.rs","thread.rs","time.rs","vcell.rs"]};
